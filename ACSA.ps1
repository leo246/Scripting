...
{
                 $domain = "clrc"
                #$strComputer = Read-Host "Computer"
                $username = Read-Host "Enter the federal ID (eg. abc12345):"
...
$System_Drawing_Point = New-Object System.Drawing.Point
$System_Drawing_Point.X = 19
$System_Drawing_Point.Y = ($form1.height - 140)
...
$form1.Controls.Add($btn13)
        ...
        $btn14.anchor = "bottom, left"
        $btn14.UseVisualStyleBackColor = $True
        $btn14.Text = "Add Admin"
        $System_Drawing_Point = New-Object System.Drawing.Point
        $System_Drawing_Point.X = 19
        $System_Drawing_Point.Y = ($form1.height - 90)
...
$lfile = "d:\scripts\logs.log"

$Trace32 = "C:\Program Files (x86)\ConfigMgr 2007 Toolkit V2\Trace32.exe"
